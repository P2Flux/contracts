...
export const feeFor = (amount, bps) => (amount * bps) / 10000n;
 ...
 */
export const paymentIdFor = (args) => keccak256(encodeAbiParameters([{ type: 'bytes32' }, { type: 'address' }, { type: 'address' }, { type: 'uint256' }, { type: 'bytes32' }], [PAYMENT_DOMAIN, args.token, args.recipient, args.amount, args.reference]));
/**
